...
package space.arim.omnibus.multiprovider.one;
...
public class AltOmnibusProviderOne implements OmnibusProviderSpi {
	@Override
	public OmnibusDefiner createDefiner() {
		return new OmnibusDefiner() {
			...
			public Omnibus getOmnibus(Class<?> callerClass) {
				return new AltOmnibusOne(new DefaultOmnibus());
			}
